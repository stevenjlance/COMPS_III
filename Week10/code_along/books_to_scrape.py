...
def scrape_page(url):
    # Get the Books to Scrape webpage
    response = requests.get(url)
    # Get the content from the GET request
    webpage = BeautifulSoup(response.content, 'html.parser')
    # Books list to return
    books = []
    # Rating dictionary
    ...
    genre_match = re.search(r'/category/books/([\w-]+)_\d+/index.html', url)
...
all_books = scrape_page("https://books.toscrape.com/catalogue/category/books/fiction_10/index.html")
